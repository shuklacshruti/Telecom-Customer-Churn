...
% ── ABSTRACT ──────────────────────────────────────────────────
\begin{abstract}
Customer churn is a key challenge in telecommunications, where retention is
more cost-effective than acquisition. This project presents an end-to-end
machine learning pipeline using the IBM Telco Customer Churn dataset (7,032
records), covering preprocessing, exploratory analysis, feature engineering,
and evaluation of three classifiers: Logistic Regression, Decision Tree, and
Random Forest. Class imbalance is addressed with SMOTE. Logistic Regression
and Random Forest achieve AUC $\approx 0.817$; feature importance analysis
identifies payment method, tenure, contract type, and monthly charges as the
strongest churn predictors.

\vspace{0.5em}

\noindent
Code: \url{https://github.com/shuklacshruti/Telecom-Customer-Churn}

\noindent
Video: \url{https://drive.google.com/file/d/1Ri-eEW48S2MfihxOYHyFVe-qEHgpm-cq/view?usp=sharing}
...
\begin{figure}[H]
 ...
 \caption{Churn distribution: 26.6\% churned, 73.4\% stayed.}
...
\begin{figure}[H]
  ...
  \caption{Pearson correlation with churn. Tenure ($r=-0.35$) is the strongest negative predictor.}
  \label{fig:corr}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Month-to-month customers churn at 42.7\%; two-year at 2.8\%.}
...
\begin{figure}[H]
  ...
  \caption{Churners average 18.0 months tenure vs.\ 37.7 months for loyal customers.}
...
\begin{figure}[H]
  ...
  \caption{Churners cluster in the upper-left (short tenure, high charges).}
